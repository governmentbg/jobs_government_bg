...
/**
 * <p>Java class for GBPositionPersonDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GBPositionPersonDataType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="PersonData" type="{http://iisda.government.bg/RAS/Common}PersonDataType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="GBPositionPersonID" use="required" type="{http://www.w3.org/2001/XMLSchema}long" /&gt;
...
@XmlType(name = "GBPositionPersonDataType", propOrder = {
    "personData"
})
public class GBPositionPersonDataType {

    @XmlElement(name = "PersonData")
    protected PersonDataType personData;
    @XmlAttribute(name = "GBPositionPersonID", required = true)
    protected long gbPositionPersonID;
    ...
    /**
     * Gets the value of the gbPositionPersonID property.
     * 
     */
    public long getGBPositionPersonID() {
        return gbPositionPersonID;
    }

    /**
     * Sets the value of the gbPositionPersonID property.
     * 
     */
    public void setGBPositionPersonID(long value) {
        this.gbPositionPersonID = value;
    }
