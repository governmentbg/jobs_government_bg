...
public interface IBatchInfoService {
    ...
    @RequestWrapper(localName = "GetBatchDetailedInfo", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.GetBatchDetailedInfo")
    @ResponseWrapper(localName = "GetBatchDetailedInfoResponse", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.GetBatchDetailedInfoResponse")
    @WebResult(name = "GetBatchDetailedInfoResult", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
    public indexbg.pjobs.wsclient.admreg.ArrayOfBatchType getBatchDetailedInfo(
        @WebParam(name = "batchIdentificationNumber", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        indexbg.pjobs.wsclient.admreg.ArrayOfString batchIdentificationNumber,
    ...
    @RequestWrapper(localName = "SearchBatchVersions", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.SearchBatchVersions")
    @ResponseWrapper(localName = "SearchBatchVersionsResponse", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.SearchBatchVersionsResponse")
    @WebResult(name = "SearchBatchVersionsResult", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
    public indexbg.pjobs.wsclient.admreg.ArrayOfVersionBatchInfoType searchBatchVersions(
        @WebParam(name = "batchIdentificationNumber", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
    ...
    @RequestWrapper(localName = "GetTerritorialAdmStructure", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.GetTerritorialAdmStructure")
    @ResponseWrapper(localName = "GetTerritorialAdmStructureResponse", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.GetTerritorialAdmStructureResponse")
    @WebResult(name = "GetTerritorialAdmStructureResult", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
    public indexbg.pjobs.wsclient.admreg.TerritorialAdmStructure getTerritorialAdmStructure(
    ...
    @RequestWrapper(localName = "SearchBatchesIdentificationInfo", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.SearchBatchesIdentificationInfo")
    @ResponseWrapper(localName = "SearchBatchesIdentificationInfoResponse", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices", className = "indexbg.pjobs.wsclient.admreg.SearchBatchesIdentificationInfoResponse")
    @WebResult(name = "SearchBatchesIdentificationInfoResult", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
    public indexbg.pjobs.wsclient.admreg.ArrayOfBatchIdentificationInfoType searchBatchesIdentificationInfo(
        @WebParam(name = "batchIdentificationNumber", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        java.lang.String batchIdentificationNumber,
        ...
        indexbg.pjobs.wsclient.admreg.AdmStructureKindsEnum admStructureKind,
        @WebParam(name = "batchType", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        indexbg.pjobs.wsclient.admreg.BatchTypeEnum batchType,
        @WebParam(name = "status", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        indexbg.pjobs.wsclient.admreg.BatchStatusEnum status,
        @WebParam(name = "dateAt", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        javax.xml.datatype.XMLGregorianCalendar dateAt,
        @WebParam(name = "versionIDAt", targetNamespace = "http://iisda.government.bg/RAS/IntegrationServices")
        java.lang.Long versionIDAt
