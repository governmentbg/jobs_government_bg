...
@Named
@ViewScoped
public class ReportA extends PJobsBean{	
	
	private static final long serialVersionUID = 8534288990429849550L;

	static final Logger LOGGER = LoggerFactory.getLogger(ReportA.class);
	...
	public void initData(){
		...
		try {
		    ...
		    if(year != null || idCamp != null) {
		    	//TODO
		    	SelectMetadata smd = new PracticeDAO(getUserData().getUserId()).repordResumoA(idCamp, year);
				String defaultSortColumn = "A1 asc";
