...
@Entity
@Table(name = "jobs_administration")
public class Administration extends TrackableEntity {


	/** Основен java Entity клас на администрация от административния регистър
	 * 
	 */
	private static final long serialVersionUID = 375800505421805552L;

	static final Logger LOGGER = LoggerFactory.getLogger(Administration.class);
	
	@SequenceGenerator(name = "Administration", sequenceName = "seq_jobs_administration", allocationSize = 1)
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Administration")
	...
	@Transient
	private List<OrgStructure> structures = new ArrayList<OrgStructure>();
	...
	public Long getCodeMainObject() {		
		return Constants.CODE_OBJECT_ADMINISTRATION;
	}
	...
	public List<OrgStructure> getStructures() {
		return structures;
	}

	public void setStructures(List<OrgStructure> structures) {
