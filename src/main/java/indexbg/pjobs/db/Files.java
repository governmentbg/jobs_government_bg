...
@SqlResultSetMapping(name = "filterByCodObjAndId", classes = {
		@ConstructorResult(targetClass = Files.class, 
				columns = { 
						...
						@ColumnResult(name = "lang", type = Long.class) 
						}) 
		})
...
public class Files extends TrackableEntity {
	...
	public Files(Long id, Long idObject, Long codeObject, String filename, String description, String contentType, Long lang) {
		super();
		this.id = id;
