...
//			System.out.println("hashBook.put(\""+bookmark.getName()+"\",\"\");");
	...
	*/
	 ...
	 * @throws Exception
	 */
	public  Document setBookmarksReturnDoc(com.aspose.words.Document docFromDB, HashMap<String,String> hashBooks) throws Exception {
		setLicense();
